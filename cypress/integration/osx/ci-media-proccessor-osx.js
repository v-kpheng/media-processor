...
//switching the source 
    ...
    it('switch source with 1 transformer', () => {
        cy.configTest('1', '30');
        cy.switchSnapAndRun('1', 'osx')
    })
    it('switch source with 2 transformers', () => {
        cy.configTest('4', '30');
        cy.switchSnapAndRun('4', 'osx')
    })
    it('switch source with 3 transformers', () => {
        cy.configTest('15', '30');
        cy.switchSnapAndRun('15', 'osx')
    })
})